...
Théoreme du barycentre :
de M, coefficient 3, N, coefficient 1, et K coefficient 7, alors \\
barycentre de $(M;3),(N;1),(K;7)\Leftrightarrow 3.\overrightarrow{GM}+1.\overrightarrow{GN}+7.\overrightarrow{GK} = \overrightarrow{0}$\\
$= 3(\overrightarrow{GO}+\overrightarrow{OM})+\overrightarrow{GO}+\overrightarrow{ON}+7(\overrightarrow{GO}+\overrightarrow{OK}=\overrightarrow{0}$\\
$=11\overrightarrow{GO}+3\overrightarrow{OM}+\overrightarrow{ON}+7\overrightarrow{OK}=\overrightarrow{0}$\\
$=\overrightarrow{OG}=\frac{3\overrightarrow{OM}+\overrightarrow{ON}+7\overrightarrow{OK}}{11}$\\
Donc $\overrightarrow{OG} = \frac{3}{11}(X_M;Y_M)+\frac{1}{11}(X_N;Y_N)+\frac{7}{11}(X_K;Y_K)$

\subsection{Les operations definies sur les vecteurs}
Il y'a plusieurs operations defini: \\
L'addition de $\overrightarrow{vecteur}$\\
Le Produit externe: $\reels. \overrightarrow{vecteur}= \overrightarrow{UnVecteur}$\\
Le Produit scalaire: $ \overrightarrow{vecteur} . \overrightarrow{vecteur} = \reels$\\
Le Produit vectoriel: $ \overrightarrow{vecteur} . \overrightarrow{vecteur} =\overrightarrow{UnVecteur}$
\subsubsection{Le produit scalaire}

   \begin{figure}[h!]
 \centering
 \includegraphics[scale=3]{image/proscla.jpg}
 \caption{Interpretation graphique }
 \label{fig:net}
 \end{figure}
 $\overrightarrow{AB}.\overrightarrow{AC}= AH$\\
 \faExclamationCircle $\overrightarrow{AB}.\overrightarrow{AC}\neq \overrightarrow{AC}.\overrightarrow{AB}$\\

 Forme générale: $\overrightarrow{u}\overrightarrow{v}=\norme{u}.\norme{v}.cos(\overrightarrow{u},\overrightarrow{v})$\\
 Donc si $\overrightarrow{u}.\overrightarrow{u}= \norme{u}.\norme{u}.cos(\overrightarrow{u},\overrightarrow{u})$\\
 $=\norme{u}.\norme{u}.cos{0}$\\
 $=\norme{u}^2.1$\\
 $=\norme{u}^2$\\
...
Quand on a les coordonnées des points, on s'embète pas :\\
$(x;y).(x';y')=xx'+yy'$\\
A noter que si $\overrightarrow{u}\perp\overrightarrow{v} \Rightarrow \overrightarrow{u}.\overrightarrow{v}=0$
\subsubsection{La Norme}
$||(x;y)||=\sqrt{x^2+y^2}$
\subsubsection{Le produit Vectoriel}
$\overrightarrow{u}\land\overrightarrow{v}=\overrightarrow{w}$\\
avec $\overrightarrow{w}$ un vecteur perpendiculaire à $\overrightarrow{u}$et $\overrightarrow{v}$ orienté selon la regle de la main droite et où :\\
$\norme{w}=\norme{u}.\norme{v}.sin(\overrightarrow{u},\overrightarrow{v})$
Si $\overrightarrow{u}\perp\overrightarrow{v}$ alors :\\
$\norme{w}=\norme{u}.\norme{v}$\\
Si $\overrightarrow{u}$ et $\overrightarrow{v}$ colinéaires alors $\norme{w}=\overrightarrow{0}$\\
Rappel :On dit que 2 vecteurs $\overrightarrow{u}$ et $\overrightarrow{v}$sont colinéaires lorsqu’il existe un réel $k$ tel que $\overrightarrow{v} =k\overrightarrow{u}$ 

La distributivité fonctionne : $ \overrightarrow{u}\land(\overrightarrow{v}+\overrightarrow{w}$\\
